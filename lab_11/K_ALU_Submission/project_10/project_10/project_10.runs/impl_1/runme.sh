...
HD_PWD='C:/Users/Student/project_10/project_10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_K_ALU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_K_ALU.tcl -notrace
