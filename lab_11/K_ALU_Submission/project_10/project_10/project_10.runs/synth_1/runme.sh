...
HD_PWD='C:/Users/Student/project_10/project_10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_K_ALU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_K_ALU.tcl
