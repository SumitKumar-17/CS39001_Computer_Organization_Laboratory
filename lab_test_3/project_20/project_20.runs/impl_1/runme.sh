...
HD_PWD='C:/Users/Student/project_20/project_20.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gcd_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gcd_module.tcl -notrace
